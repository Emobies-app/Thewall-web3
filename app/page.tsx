      ...
      <main className={styles.main}>
        {bottomTab==='home'&&<div>
          <section className={styles.walletCard+' fade-up-1'}>
            ...
            <div className={styles.goalSection}><div className={styles.goalRow}><span className={styles.goalLabel}>GOAL: $6,200,000 </span><span className={styles.goalPct}>{goalPct.toFixed(4)}%</span></div><div className={styles.goalBar}><div className={styles.goalFill} style={{width:Math.max(goalPct,0.1)+'%'}}/></div></div>
