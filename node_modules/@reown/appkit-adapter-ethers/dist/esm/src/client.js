...
import { CoreHelperUtil, OptionsController } from '@reown/appkit-core';
...
export class EthersAdapter extends AdapterBlueprint {
    ...
    async writeContract(params) {
        ...
        const result = await EthersMethods.writeContract(params, params.provider, params.caipAddress, Number(params.caipNetwork?.id));
        return { hash: result };
    }
